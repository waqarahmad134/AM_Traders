                ...
                <div class="card">
                    ...
                    <div class="col-md-4 text-right">
                        <form method="GET" action="{{ route('sale_record.index') }}" class="form-inline justify-content-end">
                            ...
                            <!-- Clear Filter -->
                            <a href="{{ route('sale_record.index') }}" class="btn btn-secondary">Clear</a>
                        </form>
                    </div>
                </div>
                        ...
                        <table id="example1" class="table table-bordered table-hover js-basic-example dataTable table-custom">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ basename($record->pdf_path, '.pdf') }}</td>
