...
@section('title', 'User Management | PSO')
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input name="ntn_strn" type="text" class="form-control" placeholder="Enter NTN / STRN">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select name="usertype" class="form-control" required readonly>
